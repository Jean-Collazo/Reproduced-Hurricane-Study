---
title: "Reproducing Excess Deaths"
author: "JEAN"
date: "12/19/2021"
...
total_pop <- sum(hh_main$hh_size) #Survey Total Population

adj_pop <- (total_pop-deaths_before_hurricane) * (102/365) #Adjusted Population after Hurricane

rate <- deaths_after_hurricane / adj_pop #Survey Death Rate after Hurricane

se <- sqrt(deaths_after_hurricane)/adj_pop #Standard Error

#Poisson Approximation

ll <- rate - 1.96*se ### Lower Limit

ul <- rate + 1.96*se ### Upper Limit
```

### Calculate excess deaths from rate

```{R, excess deaths}

### 2016 death rate from Sep 20 to Dec 31
